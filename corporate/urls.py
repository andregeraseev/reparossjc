...
from . import portal_v1830, views
...
urlpatterns = [
    ...
    path("api/corporate/v1/portal/requests", portal_v1830.portal_requests_api, name="portal_requests_api"),
    ...
    path("corporativo/", portal_v1830.portal_home, name="portal"),
    path("corporativo/p/<slug:organization_slug>/<slug:channel_slug>/", portal_v1830.portal_home, name="portal_channel"),
    path("corporativo/chamados/novo/", portal_v1830.portal_create, name="portal_create"),
    path("corporativo/pessoas/salvar/", portal_v1830.portal_person_save, name="portal_person_save"),
    path("corporativo/pessoas/<str:person_id>/alternar/", portal_v1830.portal_person_toggle, name="portal_person_toggle"),
    path("corporativo/chamados/<str:request_id>/aprovar/", portal_v1830.portal_approve, name="portal_approve"),
    path("corporativo/chamados/<str:request_id>/agendar/", portal_v1830.portal_schedule, name="portal_schedule"),
    path("corporativo/anexos/<str:attachment_id>/", portal_v1830.portal_attachment, name="portal_attachment"),
]
