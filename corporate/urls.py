...
urlpatterns = [
    ...
    path("corporativo/p/<slug:organization_slug>/<slug:channel_slug>/", views.portal_home, name="portal_channel"),
    ...
    path("corporativo/anexos/<str:attachment_id>/", views.portal_attachment, name="portal_attachment"),
]
