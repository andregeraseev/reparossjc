...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(model_name="supportdevice", index=models.Index(fields=["account", "last_seen_at"], name="support_cen_account_28fdb6_idx")),
        migrations.AddIndex(model_name="supportsnapshot", index=models.Index(fields=["device", "-created_at"], name="support_cen_device_92e8a1_idx")),
        migrations.AddIndex(model_name="supportsnapshot", index=models.Index(fields=["account", "-created_at"], name="support_cen_account_67288a_idx")),
        migrations.AddIndex(model_name="supportevent", index=models.Index(fields=["account", "-occurred_at"], name="support_cen_account_a9bdb3_idx")),
        migrations.AddIndex(model_name="supportevent", index=models.Index(fields=["device", "-occurred_at"], name="support_cen_device_063fbe_idx")),
        migrations.AddIndex(model_name="supportevent", index=models.Index(fields=["action", "-occurred_at"], name="support_cen_action_a672b3_idx")),
    ]
